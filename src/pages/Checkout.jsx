      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <input
                ...
                className="w-full px-3 py-2 rounded-md bg-gray-800 border border-gray-700 focus:outline-none focus:ring-2 focus:ring-sky-500"
              />
              <input
                type="text"
            ...
            <input
              type="email"
              placeholder="Email"
              className="mt-4 w-full px-3 py-2 rounded-md bg-gray-800 border border-gray-700 focus:outline-none focus:ring-2 focus:ring-sky-500"
            />
          </div>
        ...
        <div className="bg-gray-900 rounded-lg shadow-lg p-6 space-y-4">
          ...
          <div className="border-t border-gray-700 pt-3">
            <p className="font-medium text-gray-300">Festival de perdida del 50/50 en viviane 2025</p>
            <p className="text-gray-400 text-sm">1x VIP</p>
          </div>
          <div className="border-t border-gray-700 pt-4 flex justify-between items-center">
            <p className="font-semibold text-gray-300">Total</p>
            <p className="text-xl font-bold text-white">$100000</p>
          </div>
        </div>
      </div>
    </div>
